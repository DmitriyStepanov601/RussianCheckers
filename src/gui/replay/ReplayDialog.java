...
public class ReplayDialog extends JDialog implements ActionListener, ReplyListener {
    ...
    protected void initComponents() {
        ...
        delaySpinner.addChangeListener(e -> replay.setStepDelay(getSleepTime()));
    ...
    public void replayRefreshGui() {
        ...
        this.nextStepBtn.setEnabled(sc && selectedGame.getActualStepIndex() <
                (selectedGame.getStepCount() - 1));
